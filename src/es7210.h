...
typedef enum { ES7210_AD1_AD0_00 = 0x40 } es7210_address_t;
...
typedef enum { GAIN_0DB=0, GAIN_3DB, GAIN_6DB, GAIN_9DB, GAIN_12DB, GAIN_15DB, GAIN_18DB, GAIN_21DB, GAIN_24DB, GAIN_27DB, GAIN_30DB, GAIN_33DB, GAIN_34_5DB, GAIN_36DB, GAIN_37_5DB } es7210_gain_value_t;
